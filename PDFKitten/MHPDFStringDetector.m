...
@interface MHPDFStringDetector ()
- (void)didFindNeedle;
@property (nonatomic, assign) NSUInteger keywordPosition;
@end

@implementation MHPDFStringDetector
...
- (BOOL)append:(NSString *)string isLast:(BOOL *)isLast font:(MHPDFFont *)font
{
...
- (NSString *)stringByExpandingLigatures:(NSString *)string font:(MHPDFFont *)font
{
